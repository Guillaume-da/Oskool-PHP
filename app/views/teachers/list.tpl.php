...
<table class="table table-hover mt-4">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-right">
                <a href="<?=$router->generate('teachers-update', ['teacher_id'=>$currentTeacher->getId()]) ?>" class="btn btn-sm btn-warning">
                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="<?=$router->generate('teacher-delete', ['teacher_id'=>$currentTeacher->getId()]) ?>">Oui, je veux supprimer</a>
